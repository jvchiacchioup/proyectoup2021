...
<body>
 ...
 <body>
	<h2>Registrate</h2>
    <form  class="formreg" action="registro.php" method="post" >
    	<label><p>Nombre</p>
        ...
        <label><p>Nombre de usuario</p>
        	<input name="usuario" type="text" maxlength="20" />
        </label><br />
        <label><p>Contraseña</p>
        	<input type="password" name="password" maxlength="20" />
        </label><br />
        	<label>
            <input name="newsletter" type="checkbox" value="si" checked="checked" /> Sí, deseo recibir datos surreales por mail.
            </label><br />
            <input type="submit" class="btn btn-outline-warning botones" value="Registrarse"/>	
    </form>
